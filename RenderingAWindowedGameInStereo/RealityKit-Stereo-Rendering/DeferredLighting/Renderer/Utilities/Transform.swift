...
enum Transform {
    ...
    /// A 4 x 4 translation matrix specified by x, y, and z components.
    ...
    /// A 4 x 4 rotation matrix specified by an angle and an axis or rotation.
    ...
    /// A 4 x 4 uniform scale matrix specified by x, y, and z components.
    ...
    /// Returns a 3 x 3 normal matrix from a 4 x 4 model matrix.
    ...
    /// Returns a left-handed matrix that looks from a point (the "eye") at a target point, given the up vector.
